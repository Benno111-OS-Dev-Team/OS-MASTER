...
require_file "$ROOT_DIR/kernel/media/bootstrap_images/default.svg"
...
mkdir -p "$OUTPUT_ROOT/assets/themes"
...
cp "$ROOT_DIR/kernel/media/bootstrap_images/default.svg" "$OUTPUT_ROOT/assets/wallpapers/default.svg"
