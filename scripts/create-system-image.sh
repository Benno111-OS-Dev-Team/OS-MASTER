...
require_file "$ROOT_DIR/assets/boot-assets/logo.svg"
require_file "$ROOT_DIR/assets/boot-assets/bar.svg"
require_file "$ROOT_DIR/assets/boot-assets/progress.png"
...
mkdir -p "$OUTPUT_ROOT/assets/boot-assets"
...
cp "$ROOT_DIR/assets/boot-assets/logo.svg" "$OUTPUT_ROOT/assets/boot-assets/logo.svg"
cp "$ROOT_DIR/assets/boot-assets/bar.svg" "$OUTPUT_ROOT/assets/boot-assets/bar.svg"
cp "$ROOT_DIR/assets/boot-assets/progress.png" "$OUTPUT_ROOT/assets/boot-assets/progress.png"
