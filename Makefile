...
.PHONY: all kernel image sdk qemu qemu-bios qemu-uefi qemu-debug clean distclean \
        check-source-complete check-xnu-integration check-xnu-build-env check-xnu-boot-abi check-xnu-boot-surface check-xnu-uefi-handoff check-xnu-entry-handoff check-xnu-uefi-boot-image check-xnu-uefi-boot-smoke \
...
check-xnu-integration check-xnu-build-env check-xnu-boot-abi check-xnu-boot-surface check-xnu-uefi-handoff check-xnu-entry-handoff check-xnu-uefi-boot-image check-xnu-uefi-boot-smoke storage-format-stress storage-driver-compile-check \
