...
.PHONY: all kernel image sdk qemu qemu-bios qemu-uefi qemu-debug clean distclean \
        check-source-complete check-xnu-integration check-xnu-build-env check-xnu-boot-abi \
...
check-xnu-integration check-xnu-build-env check-xnu-boot-abi storage-format-stress storage-driver-compile-check \
